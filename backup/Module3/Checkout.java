...
public class Checkout {
    ...
    public Boolean verifyInsufficientBalanceMessage() {
        try {
            ...
            String expectedErrorMessege = "You do not have enough balance in your wallet for this purchase";
            WebElement warningMessege = driver.findElement(By.xpath("//div[@id='notistack-snackbar']"));
            String actualErrorMessege = warningMessege.getText();
            if(expectedErrorMessege.equals(actualErrorMessege)){
                return true;
            }
            return false;
        } catch (Exception e) {
